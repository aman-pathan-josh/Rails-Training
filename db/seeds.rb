...
# UserRole.create(user: user1.id, role: admin_role)
# UserRole.create(user: user2.id, role: customer_role)
# UserRole.create(user: user3.id, role: customer_role)
...
# UserRestaurant.create(user: user1.id, restaurant: restaurant1)
# UserRestaurant.create(user: user1.id, restaurant: restaurant2)
